...
logdir=${OVS_LOGDIR-'/home/cclamb/Work/trema/objects/openvswitch/var/log/openvswitch'}                 # /var/log/openvswitch
rundir=${OVS_RUNDIR-'/home/cclamb/Work/trema/tmp/sock'}                 # /var/run/openvswitch
sysconfdir=${OVS_SYSCONFDIR-'/home/cclamb/Work/trema/objects/openvswitch/etc'}     # /etc
etcdir=$sysconfdir/openvswitch                  # /etc/openvswitch
datadir=${OVS_PKGDATADIR-'/home/cclamb/Work/trema/objects/openvswitch/share/openvswitch'}        # /usr/share/openvswitch
bindir=${OVS_BINDIR-'/home/cclamb/Work/trema/objects/openvswitch/bin'}                 # /usr/bin
sbindir=${OVS_SBINDIR-'/home/cclamb/Work/trema/objects/openvswitch/sbin'}              # /usr/sbin
